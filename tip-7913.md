```
tip: 7913
title: Signature Verifiers for Address-less Keys (Compatible with ERC-7913)
description: A standard interface for verifying signatures produced by keys without dedicated on-chain addresses, compatible with ERC-7913
